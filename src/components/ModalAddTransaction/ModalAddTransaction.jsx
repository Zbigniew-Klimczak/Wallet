...
import PlusSvg from "../../assets/svg/icons.svg";
import MinusSvg from "../../assets/svg/icons.svg";
        ...
        {({ setFieldValue, values }) => (
          <Form className={styles.form}>
            <div className={styles.transTypeContainer}>
              <span className={incomeActiveTrigger()}>Income</span>
              ...
              <div className={styles.switchToggleContainer}>
                ...
                <span className={switchToggle()}>
                  <ReactSVG
                    ...
                    src={transactionType === "income" ? PlusSvg : MinusSvg}
                  />
                </span>
              </div>
              ...
              <input
                ...
                defaultChecked
              />
              <span className={spendingActiveTrigger()}>Consumption</span>
            </div>
